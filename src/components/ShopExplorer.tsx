      ...
      <div className="flex flex-col sm:flex-row gap-3 mb-8">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 border border-[var(--color-border)] rounded-xl text-sm text-espresso focus:outline-none focus:border-caramel"
          />
        </div>
        <select
          value={selectedCity}
          onChange={(e) => setSelectedCity(e.target.value)}
          className="border border-[var(--color-border)] rounded-xl px-4 py-2.5 text-sm text-espresso bg-[var(--color-surface)] focus:outline-none focus:border-caramel"
        >
        ...
        <select
          ...
          className="border border-[var(--color-border)] rounded-xl px-4 py-2.5 text-sm text-espresso bg-[var(--color-surface)] focus:outline-none focus:border-caramel capitalize"
        >
